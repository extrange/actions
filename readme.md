...
jobs:
  devenv-test:
    uses: extrange/actions/.github/workflows/devenv-test.yml@v1.7
```
...
jobs:
  devenv-update:
    uses: extrange/actions/.github/workflows/devenv-update.yml@v1.7
...
jobs:
  get-commit-metadata:
    uses: extrange/actions/.github/workflows/commit-metadata.yml@v1.7

  build:
    uses: extrange/actions/.github/workflows/build.yml@v1.7
